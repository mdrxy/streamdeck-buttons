"""
CRUD routes for managing users. Creating, reading, updating, and
deleting users all require superuser privileges.
"""
...
def delete_user(
    ...
    statement = delete(Button).where(col(Button.created_by) == user_id)
